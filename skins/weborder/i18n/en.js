define(function() {
    return {
        ...
        'PROMOTIONS_ALL': 'See all Promotions',
        'PROMOTIONS_AVAILABLE': 'Available Promotions',
        'PROMOTIONS_AVAILABLE_DESC': 'Choose one or more promotions to apply to your order',
        ...
        'PROMOTIONS_OTHER_DESC': 'These will become available if your order qualifies',
        ...
        'STORE_INFO_OPEN_NOW': 'Open Now',
        'STORE_INFO_CLOSED_NOW': 'Closed Now',
        'STORE_INFO_VIEW_OPEN_HOURS': 'View Open Hours',
        'SUBCATEGORIES_SUBCATEGORIES': 'Sub-Categories',
        'TIPS_ADD_TIP': 'Tip with',
        'TIPS_NONE': 'None',
        'TIPS_OTHER': 'Other',
        ...
        'STANFORD_NEED_PIN_VALIDATION': 'Your card requires validation of an Account Code. Please, enter <br>the account code and try again.',
        ...
        'REWARDS_INFORMATION': 'Loyalty Information',
        'REWARDS_NUMBER': 'Loyalty #',
        ...
        'STANFORD_CARD_RELOAD': 'Stanford Card Reload',
