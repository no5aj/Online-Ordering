...
(function(root, factory) {
  ...
  Epoxy.View = Backbone.View.extend({
    ...
    applyBindings: function() {
      ...
      self.viewModel = addSourceToViewContext(self, context, options, 'viewModel', '', self); //EE: fixed to send view context to the viewModel user function
  ...
  function addSourceToViewContext(source, context, options, name, prefix, view) {
